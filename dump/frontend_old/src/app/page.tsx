...
const ThreeDHero = dynamic(() => import("@/components/ThreeDHero"), { ssr: false, loading: () => <div style={{height: '24rem'}} className="w-full flex items-center justify-center"><span className="loader" /></div> });
