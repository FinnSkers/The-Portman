...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {/* Modern Header */}
        <header className="w-full flex justify-center items-center px-8 py-4 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl shadow-lg sticky top-0 z-50 border-b border-indigo-100 dark:border-indigo-900">
          <nav className="flex items-center justify-between w-full max-w-7xl mx-auto gap-8">
            ...
            <ul className="hidden md:flex items-center gap-8 text-base font-semibold text-gray-700 dark:text-gray-200">
              <li>
                <a
                  href="#features"
