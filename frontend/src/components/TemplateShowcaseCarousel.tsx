  ...
  return (
    <section className="w-full max-w-3xl mx-auto py-12 flex flex-col items-center animate-fade-in-up">
      ...
      <div className="relative w-full flex items-center justify-center">
        <button onClick={prev} className="absolute left-0 z-10 bg-white/80 dark:bg-gray-900/80 rounded-full p-2 shadow hover:bg-indigo-100 dark:hover:bg-gray-800 transition">
          &#8592;
        </button>
        <AnimatePresence mode="wait">
          ...
          >
            <GlassCard className="flex flex-col items-center p-8">
              <img src={templates[index].image} alt={templates[index].name} className="w-24 h-24 mb-4" />
        ...
        <button onClick={next} className="absolute right-0 z-10 bg-white/80 dark:bg-gray-900/80 rounded-full p-2 shadow hover:bg-indigo-100 dark:hover:bg-gray-800 transition">
          &#8594;
        </button>
      </div>
    </section>
